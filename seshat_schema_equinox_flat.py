...
scoped_properties = [
    ...
    ("Social_Complexity_variables_Hierarchical_Complexity_Administrative_levels","IntegerRange",[],"Social Complexity variables|Hierarchical Complexity|Administrative levels",""),
    ("Social_Complexity_variables_Hierarchical_Complexity_Military_levels","IntegerRange",[],"Social Complexity variables|Hierarchical Complexity|Military levels",""),
    ("Social_Complexity_variables_Hierarchical_Complexity_Religious_levels","IntegerRange",[],"Social Complexity variables|Hierarchical Complexity|Religious levels",""),
    ("Social_Complexity_variables_Hierarchical_Complexity_Settlement_hierarchy","IntegerRange",[],"Social Complexity variables|Hierarchical Complexity|Settlement hierarchy",""),
